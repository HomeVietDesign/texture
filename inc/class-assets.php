...
class Assets {
	...
	public static function enqueue_styles() {
		...
		wp_enqueue_style( 'vlxd', THEME_URI.'/assets/css/main.css', $deps, date('YmdHis', filemtime(THEME_DIR . '/assets/css/main.css')) );
	}
	...
	public static function enqueue_scripts() {
		...
		wp_enqueue_script( 'vlxd', THEME_URI.'/assets/js/main.js', $deps, date('YmdHis', filemtime(THEME_DIR . '/assets/js/main.js')), true);
