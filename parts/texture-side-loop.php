	...
	<div class="inner border bg-white">
		<div class="images position-relative border-bottom">
			...
			if(has_role('administrator')) {
				?>
				<a class="edit-texture-button position-absolute start-0 bottom-0 z-2 d-block p-1 lh-1 text-info" href="<?php echo esc_url(get_edit_post_link( $texture->id )); ?>" target="_blank">
